package midterm_practice_2.prob2.admin;

import midterm_practice_2.prob2.Course;
import midterm_practice_2.prob2.PlanOfStudy;
import midterm_practice_2.prob2.Student;
import midterm_practice_2.prob2.Transcript;
	...
	public static List<Course> coursesTaughtByValentine(List<Student> allStudents) {
		...
		for (Student student: allStudents) {
			for (Course course: student.getPlanOfStudy().getCourseList()) {
				...
				if (course.getPrimaryProfessor().equalsIgnoreCase("Valentine")) {
