package final_practice.prog8.prob8;
...
//    }
    ...
    private boolean findProduct(String prodName) {
        return orderItems.stream().filter(Objects::nonNull).map(OrderItem::getProduct).anyMatch(x -> x.getProductName().equals(prodName));
    }
