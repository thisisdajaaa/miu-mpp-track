package final_practice.prog11.prob3;

import java.util.Arrays;
import java.util.List;
import java.util.stream.Collectors;

import static final_practice.prog11.prob3.FunctionWithException.unchecked;

public class FixThis {
    List<String> processList(List<String> list) {

        return list.stream()
                .map(x -> unchecked(this::doNothingIfShort).apply(x)) // This will fail to compile
