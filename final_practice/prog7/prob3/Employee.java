package final_practice.prog7.prob3;
...
public class Employee {
    ...
    public static void main(String[] args) {
        ...
        list.stream().sorted(Comparator.comparing(Employee::getName).thenComparing(Employee::getSalary, Comparator.reverseOrder())).toList().forEach(System.out::println);
    }
}
